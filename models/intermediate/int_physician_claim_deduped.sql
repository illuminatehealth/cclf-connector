...
, filter_claims as (
    ...
    select
        ...
        , sort_adjusted_claims.rndrg_prvdr_fips_st_cd
        ...
        , sort_adjusted_claims.clm_line_cvrd_pd_amt as clm_line_cvrd_pd_amt
        ...
        , sort_adjusted_claims.clm_line_alowd_chrg_amt as clm_line_alowd_chrg_amt
...
, mapping as (
    ...
    select
        ...
        , null as operating_npi
        , null as attending_npi
        , null as other_npi
        ...
        , rndrg_prvdr_fips_st_cd as x_rendering_fips_state_code
...
, add_data_types as (
    ...
    select
        ...
        , cast(operating_npi as {{ dbt.type_string() }} ) as operating_npi
        , cast(attending_npi as {{ dbt.type_string() }} ) as attending_npi
        , cast(other_npi as {{ dbt.type_string() }} ) as other_npi

...
/* logic to find the first paid date for a given natural key */
...
, filter_claims as (
    ...
    select
        ...
        , sort_adjusted_claims.clm_pmt_amt as clm_pmt_amt
        , sort_adjusted_claims.prvdr_fac_fips_st_cd
        ...
        , clm_mdcr_instnl_tot_chrg_amt as clm_mdcr_instnl_tot_chrg_amt
...
, add_claim_line_details as (
    ...
    select
        ...
        , filter_claims.prvdr_fac_fips_st_cd
        ...
        , filter_claims.clm_hipps_uncompd_care_amt 
        , filter_claims.clm_mdcr_ip_pps_cptl_ime_amt 
        , filter_claims.clm_oprtnl_ime_amt 
        , filter_claims.clm_mdcr_ip_pps_dsprprtnt_amt 
        , filter_claims.clm_oprtnl_dsprprtnt_amt
        , revenue_center.clm_line_num
        , revenue_center.clm_line_from_dt
        , revenue_center.clm_line_thru_dt
        , revenue_center.clm_line_instnl_rev_ctr_dt
        ...
        , revenue_center.clm_rev_apc_hipps_cd
...
, mapping as (
    ...
    select
        ...
        , coalesce(cast(clm_line_num as {{ dbt.type_int() }}), 1) as claim_line_number
        ...
        , clm_blg_prvdr_oscar_num as ccn
        ...
        , clm_line_instnl_rev_ctr_dt as x_revenue_center_date
        , clm_rev_apc_hipps_cd as x_revenue_center_apc_hipps_code
        ...
        , prvdr_fac_fips_st_cd as x_facility_fips_state_code
        ...
        , case
            ...
            when coalesce(cast(clm_line_num as {{ dbt.type_int() }}), 1) = 1 then
              ...
              - {{ cast_numeric('clm_oprtnl_ime_amt') }}
              - {{ cast_numeric('clm_mdcr_ip_pps_dsprprtnt_amt') }}
              - {{ cast_numeric('clm_oprtnl_dsprprtnt_amt') }}
            else 0
...
, add_data_types as (
    ...
    select
        ...
        , {{ try_to_cast_date('x_revenue_center_date', 'YYYY-MM-DD') }} as x_revenue_center_date
        , cast(x_revenue_center_apc_hipps_code as {{ dbt.type_string() }} ) as x_revenue_center_apc_hipps_code
...
select
    ...
    , drg_code
    , revenue_center_code
    , x_revenue_center_date
    , x_revenue_center_apc_hipps_code

...
select
    ...
    , claim_type
    , claim_type_code
    , coalesce(x_claim_type_code, cast(claim_type_code as {{ dbt.type_string() }})) as x_claim_type_code
    , person_id
    , member_id
    , payer
    , {{ quote_column('plan') }}
    ...
    , bill_type_code
    , case when drg_code is not null then 'ms-drg' else null end as drg_code_type
    , drg_code
    , revenue_center_code
    ...
    , net_paid_amount
    , allowed_amount
    , net_paid_amount as x_cclf_net_paid_amount
    , charge_amount
    , coinsurance_amount
    , copayment_amount
    , deductible_amount
